...
export default function UpperBound({
  ...
  return getBoxed(type,
        <TextField
          ...
          slotProps={{
            input : {
              startAdornment: type === "UB" && <InputAdornment position="start">&le;</InputAdornment>,
              endAdornment: type === "LB" && <InputAdornment position="end">&le; </InputAdornment>,
            }
          }}
          value={bound}
          label={type.toString()}
